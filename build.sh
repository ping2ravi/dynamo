...
docker run --name=DynamoBuild -e MVN_COMMAND="clean verify -P all-tests " -v ${cwd}/target:/root/target -v ~/.m2:/root/.m2/ -e GIT_REPO=https://github.com/ping2ravi/dynamo.git --net=host ping2ravi/maven-build-docker:latest
