...
@SpringView(name = "domainPage")
public class DomainTemplatePage extends VerticalLayout implements View{
	...
	@Autowired
	public DomainTemplatePage(DynamoService dynamoService, DomainEditor editor) {
	...
	private void listDomains(String text) {
		try {
			if (StringUtils.isEmpty(text)) {
				...
				grid.setContainerDataSource(new BeanItemContainer(Domain.class, domains.getContent()));
			} else {
